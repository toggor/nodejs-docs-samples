  ...
  describe('jobs', function () {
    describe('create', function () {
      it('should create a transfer job', function () {
        ...
        assert.equal(callback.firstCall.args.length, 2, 'callback received 2 argument2');
        ...
        assert.equal(callback.secondCall.args.length, 2, 'callback received 2 argument2');
    ...
    describe('set', function () {
      it('should update a transfer job', function () {
        ...
        assert.equal(callback.thirdCall.args.length, 2, 'callback received 2 argument2');
